<nav class="bg-gray-900 rounded-b-2xl border-gray-200" x-data="{ open: false }">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-2 md:p-4">
        ...
        <div :class="{ 'block': open, 'hidden': !open }" class="hidden w-full md:block md:w-auto" id="navbar-default">
            <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-700 rounded-lg bg-gray-900 md:flex-row md:space-x-6 md:mt-0 md:border-0">
                <li>
                    <a href="#" class="block py-2 px-3 rounded text-white hover:bg-gray-400 md:hover:bg-transparent md:border-0 md:hover:text-blue-500">Home</a>
                </li>
                <li>
                    <a href="#" class="block py-2 px-3 rounded text-white hover:bg-gray-400 md:hover:bg-transparent md:border-0 md:hover:text-blue-500">Menu</a>
                </li>
                <li>
                    <a href="#" class="block py-2 px-3 rounded text-white hover:bg-gray-400 md:hover:bg-transparent md:border-0 md:hover:text-blue-500">Login</a>
                </li>
            </ul>
        </div>
    </div>
