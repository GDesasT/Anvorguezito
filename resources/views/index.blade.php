...
@section('content')
<div class="bg-cover bg-center h-screen flex items-center justify-center rounded-xl" style="background-image: url('../img/parrilla.jpg');">
    <div class="container mx-auto px-4 py-16 md:py-24 animate-fadeInUp">
        <div class="flex flex-col md:flex-row md:space-x-8 items-center">
            <div class="md:w-1/2 flex justify-center">
                <div class="md:w-1/2 md:h-1/2 w-32 h-32 flex justify-center items-center bg-white rounded-full shadow-lg transform hover:scale-105 transition-transform duration-300">
...
<div class="container mx-auto mt-12 px-4">
    <div x-data="carouselData()" class="relative w-full">
        ...
        <button @click="prevSlide()" id="prev" class="absolute top-0 left-0 z-30 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none">
            <span class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-black/30 group-hover:bg-black/50 group-focus:ring-4 group-focus:ring-white">
